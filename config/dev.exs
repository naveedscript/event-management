...
config :event_managment_web, EventManagmentWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "54hi7U+VgXK51cML+WyPqwY2GnEGksRjimjd1ndYESdpwLiUijmd6Dne06xlbi5H",
  watchers: []
...
config :event_managment_web, dev_routes: true
